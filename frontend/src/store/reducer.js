...
export const INITIAL_STATE = {
  ...
  kgError: null,
  kgDefaultModel: null,
  kgVisibleSections: ["graph", "summary", "triplets"],
  kgGraphViewMode: "organized",
  kgScoreMode: "audio",
  kgScoreDetail: 1,
  kgScoreDifficulty: 1,
  scriptCompareSelectedKgResultId: "",
  scriptCompareKgResults: [],
  scriptCompareKgProjectId: null,
  scriptCompareResult: null,
  scriptCompareHistory: [],
  scriptCompareHistoryProjectId: null,
  scriptCompareMode: "audio",
  scriptCompareDetail: 1,
  scriptCompareDifficulty: 1,
  scriptCompareBusy: false,
  scriptCompareLoadingKg: false,
  scriptCompareLoadingHistory: false,
  scriptCompareError: null,
  homeQuery: "",
  homeSortKey: "updated_desc",
  sessionId: null,
  baseline:  null,
  projectMeta: null,
...
export function reducer(state, action) {
  switch (action.type) {
    ...
    case "RESET":
      return {
        ...INITIAL_STATE,
        kgVariants: state.kgVariants,
        kgSelectedVariantIds: state.kgSelectedVariantIds,
        kgDefaultModel: state.kgDefaultModel,
        kgVisibleSections: state.kgVisibleSections,
        kgGraphViewMode: state.kgGraphViewMode,
        scriptCompareMode: state.scriptCompareMode,
        scriptCompareDetail: state.scriptCompareDetail,
        scriptCompareDifficulty: state.scriptCompareDifficulty,
